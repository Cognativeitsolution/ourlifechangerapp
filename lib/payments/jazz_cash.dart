...
class JazzCash extends StatefulWidget {
  var amount, account;
  JazzCash({Key, key, required this.amount, required this.account})
      : super(key: key);
...
class _JazzCashState extends State<JazzCash> {
  ...
  payment() async {
    ...
    String pp_MerchantID = "MC55327";
    String pp_Password = "8v317wcyy4";
    ...
    String IntegeritySalt = "f5y6dwtyhz";
    String and = '&';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("Account Number:  " + widget.account),
          SizedBox(
            height: 20,
          ),
